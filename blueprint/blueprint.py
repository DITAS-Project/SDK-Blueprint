...
class Blueprint:
    ...
    def add_is_data_sources(self):
        ...
        for dal_config in self.dal_configs:
            ...
            with open(dal_config.get_path_from_section(MAIN_PROTO), 'r') as main_proto:
                main_proto_folder = os.path.abspath(os.path.join(dal_config.get_path_from_section(MAIN_PROTO), os.pardir))
            ...
            main_proto_file_name = os.path.basename(dal_config.get_section(MAIN_PROTO))
    ...
    def save(self):
        file_path = self.vdc_config.get_path_from_section(BLUEPRINT)
